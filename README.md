...
Welcome to my repository for custom game server eggs designed for the **Pelican Panel**! 🚀
...
*(💡 **Bonus:** There is also a **⚙️ Custom Egg** (`minecraft/java/custom/`) included in this repository that allows for more flexible setups supporting loaders like PaperMC, Folia, Purpur, and vanilla Forge!)*

## 🚀 How to Install

1. Download the `.json` file of the Egg you want to use (e.g., `egg-minecraft-java-fabric.json`).
2. Log into your Pelican Panel as an **Administrator**.
3. Navigate to **Nests** in the admin sidebar and select your target Nest (usually *Minecraft*).
